...
class MoldingPageLocators:
    ...
    MOLDING_IMAGE_VOLUME = (By.ID, "com.logitech.uefits:id/image_view_volume")
    MOLDING_BAR_ADJUST_VOLUME = (By.ID, "com.logitech.uefits:id/seek_bar_adjust_volume")
    MOLDING_CANCEL_BUTTON = (By.ID, "com.logitech.uefits:id/text_view_cancel")
    MOLDING_START_TITLE = (By.ID, "com.logitech.uefits:id/text_view_start_title")
    MOLDING_START_SUBTITLE = (By.ID, "com.logitech.uefits:id/text_view_start_subtitle")
    MOLDING_PROGRESS_BAR = (By.ID, "com.logitech.uefits:id/progress_bar")
