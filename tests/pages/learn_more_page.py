...
class LearnMorePage(BasePage):
    ...
    def should_be_carousel_controls(self):
        self.is_element_present(*LearnMoreLocators.CAROUSEL_CONTROLS), "No carousel controls"
    ...
    def should_be_double_tap_control_video(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_VIDEO), "Double tap control video not found"
    ...
    def should_be_custom_control_message(self):
        self.check_screen_message("Left and Right Double tap controls can be customized independently"
                                  " in the settings menu")

    def should_be_custom_control_image(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_IMAGE), "Custom Control image not found"
    ...
    def should_be_switching_devices_image(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_IMAGE), "Switching devices image not found"
    ...
    def should_be_eq_customization_image(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_IMAGE), "EQ Customization image not found"
    ...
    def should_be_tyf_image(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_IMAGE), "Test Your Fit image not found"
    ...
    def should_be_pair_device_animation(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_VIDEO), "Pair a new device animation not found"
    ...
    def should_be_status_indicators_animation(self):
        self.is_element_present(*LearnMoreLocators.SCREEN_IMAGE), "Status indicators image not found"
