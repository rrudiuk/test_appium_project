...
class TestSmokeTest:
    ...
    def test_every_selection_left_double_tap(self, driver):
        ...
        settings_page.tap_left_double_tap_item()
        settings_page.should_be_double_tap_items_screen()
        settings_page.select_double_tap_google_assistant()
        settings_page.save_selection()
        settings_page.should_be_google_assistant_selected_double_tap_left()
        # play_pause
        settings_page.tap_left_double_tap_item()
        settings_page.should_be_double_tap_items_screen()
    ...
    def test_every_selection_right_double_tap(self, driver):
        ...
        settings_page.select_double_tap_google_assistant()
        settings_page.save_selection()
        settings_page.should_be_google_assistant_selected_double_tap_right()
        # next_track
        settings_page.tap_right_double_tap_item()
        settings_page.should_be_double_tap_items_screen()
        settings_page.select_double_tap_next_track()
